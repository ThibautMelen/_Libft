...
/*   Updated: 2018/04/12 14:28:57 by thmelen          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_list *ft_lstnew(void const *content, size_t content_size)
{
  ...
  {
    if (!(new_element->content = (void *)malloc(sizeof(void) * content_size)))
      return (NULL);
    new_element->content = ft_memcpy(new_element->content, content, content_size);
